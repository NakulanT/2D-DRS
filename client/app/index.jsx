  ...
  return (
    <View className="flex-1 justify-center items-center bg-slate-200">
      <Text className="text-5xl font-bold mb-6">
        Open up doooo.js to start working on your fun app!
      </Text>
      <StatusBar style="auto" />

      {/* Parent container with flex to arrange boxes side by side */}
      <View className="flex-row justify-around space-x-4 w-full px-8 items-center ">
        {/* Container for the Record box */}
          <Link
            href="/record"
            className="text-3xl font-bold underline text-blue-600 text-center"
          >
